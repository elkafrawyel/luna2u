...
public class SearchLiveChannels_Adapter extends RecyclerView.Adapter<SearchLiveChannels_Adapter
    ...
    public SearchLiveChannels_Adapter(ArrayList<LiveChannelsModel> data,
                                      Context mContext) {
        Data = data;
        ...
        LiveChannels_ViewHolder (View itemView) {
            ...
            logo.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    i.putExtra("url",FilteredData.get(getAdapterPosition()).getUrl());

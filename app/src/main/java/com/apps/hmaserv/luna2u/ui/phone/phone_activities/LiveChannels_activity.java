...
import com.apps.hmaserv.luna2u.ui.phone.phone_dialogs.SearchLiveChannelsDialog;
...
public class LiveChannels_activity extends AppCompatActivity
    ...
    public void onSuccess(String result) throws JSONException {
        ...
        for (int i = 0; i < array.length(); i++) {
            ...
            LiveChannelsModel temp = LunaDatabase.getInstance(LiveChannels_activity.this)
        ...
        adapter = new LiveChannels_Adapter(Channels, LiveChannels_activity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            startActivity(new Intent(this, LiveSettings_activity.class));
            return true;
        } else if (id == R.id.action_search) {
            if (Channels.size() > 0) {
                firstTime = false;
                SearchLiveChannelsDialog dialog = new SearchLiveChannelsDialog(
                        this, Channels, new SearchLiveChannelsDialog.ISearchDialog() {
                    @Override
            ...
            firstTime = false;
            Intent i = new Intent(this, Favorite_activity.class);
    ...
    private void ApplyChanges() {
        if (!firstTime) {
            ...
            Favs = (ArrayList<LiveChannelsModel>) LunaDatabase.getInstance(LiveChannels_activity.this)

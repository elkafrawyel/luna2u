...
import com.apps.hmaserv.luna2u.ui.phone.phone_adapters.LiveGroups_Adapter;
...
public class LiveGroups_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_live_groups);
                        ...
                        makeStringResponse(ServerURL.LiveGroups_Url.concat(code),
                                new VolleySingleton.VolleyCallback() {
                                    ...
                                    public void onSuccess(String result) throws JSONException {
                                        ...
                                        adapter = new LiveGroups_Adapter(LiveCats, LiveGroups_activity.this);
                                ...
                                , new VolleySingleton.JsonVolleyCallbackError() {
                                    ...
                                    public void onError(VolleyError error) {
                                        Handler.volleyErrorHandler(error,LiveGroups_activity.this);
                        ...
                        new VolleySingleton.VolleyCallback() {
                            ...
                            public void onSuccess(String result) throws JSONException {
                                ...
                                if (code.equals("0") && status.equals("success") && message.equals("Valid")) {
                                    ...
                                    MDToast.makeText(LiveGroups_activity.this, "Your Activation Code is Expired!!", Toast.LENGTH_SHORT,MDToast.TYPE_WARNING).show();
                                    NewApplication.getPreferencesHelper().clear();
                                    LiveGroups_activity.this.finish();
                                    startActivity(new Intent(LiveGroups_activity.this, Login_activity.class));
                                }
                            }
                        }
                        , new VolleySingleton.JsonVolleyCallbackError() {

...
import com.apps.tv.luna2u.ui.phone.phone_dialogs.Phone_ChoosePlayerDialog;
import com.apps.tv.luna2u.ui.tv.tv_dialogs.QuickListDialog;
...
import static com.apps.tv.luna2u.ui.LauncherActivity.MOBILE;
import static com.apps.tv.luna2u.ui.LauncherActivity.TV;
                ...
                VolleySingleton.getInstance().makeStringResponse(Channels_Url,
                        new VolleySingleton.VolleyCallback() {
                            ...
                            public void onSuccess(String result) throws JSONException {
                                ...
                                mCurrentIndex = Channels.indexOf(mCurrentChannel);

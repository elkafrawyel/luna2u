...
import com.apps.tv.luna2u.ui.tv.tv_Models.TV_IconHeaderItem;
import com.apps.tv.luna2u.ui.tv.tv_Presenters.IconHeaderItemPresenter;
...
import com.apps.tv.luna2u.utils.VolleySingleton.JsonVolleyCallbackError;
...
public class TV_MainFragment extends BrowseSupportFragment {
    ...
    private void CallInfo(final String code) {
        ...
        mRequestQueue.add(
                VolleySingleton.getInstance().makeStringResponse(true,
